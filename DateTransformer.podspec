#
#  Be sure to run `pod spec lint DateTransformer.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
		A DateTransformer convert date to string using custom formats and visversa.
                   DESC
  ...
  spec.author             = { "Khaled Mahmoud" => "khaled.mahmoud@asgatech.com" }
  # Or just: spec.author    = "Khaled Mahmoud"
  # spec.authors            = { "Khaled Mahmoud" => "khaled.mahmoud@asgatech.com" }
  # spec.social_media_url   = "https://twitter.com/Khaled Mahmoud"
